...
import static com.easyphotopicker.EasyImageFiles.singleFileList;
...
public class EasyImage implements Constants {
    ...
    public static void openDocuments(Fragment fragment, int type) {
        Intent intent = createDocumentsIntent(fragment.getActivity().getBaseContext(), type);
    ...
    public static void openGallery(Fragment fragment, int type) {
        Intent intent = createGalleryIntent(fragment.getActivity().getBaseContext(), type);
